...
char nodeName[] = "ESP32_SmartRoom";

// define the Device Names
char deviceName_1[] = "Room Light";
char deviceName_2[] = "PC";
char deviceName_3[] = "Alexa";
char deviceName_4[] = "Mood Light";
char deviceName_5[] = "Fan";

//Update the HEX code of IR Remote buttons 0x<HEX CODE>
#define IR_Button_1   0x20DF8877
#define IR_Button_2   0x20DF48B7
#define IR_Button_3   0x20DFC837
#define IR_Button_4   0x20DF28D7
#define IR_Button_5   0x20DFA857
#define IR_Fan_Up     0x20DFA25D
#define IR_Fan_Down   0x20DF629D
#define IR_All_On     0x20DF10EF
#define IR_All_Off    0x20DF22DD
...
const char *service_name = "PROV_SmartRoom";
...
static uint8_t RelayPin1 = 15;  //D23
static uint8_t RelayPin2 = 23;  //D22
static uint8_t RelayPin3 = 4 ;  //D21
static uint8_t RelayPin4 = 22;  //D19

static uint8_t SwitchPin1 = 39;  //D13
static uint8_t SwitchPin2 = 34;  //D12
static uint8_t SwitchPin3 = 35;  //D14
static uint8_t SwitchPin4 = 32;  //D27
static uint8_t SwitchPin5 = 33;  //D26

static uint8_t FanRelay1 = 5 ;  //D18
static uint8_t FanRelay2 = 18;  //D5
static uint8_t FanRelay3 = 19;  //D25
static uint8_t FanRelay4 = 21;  //D25

static uint8_t FanSwitch1 = 13;  //D33
static uint8_t FanSwitch2 = 12;  //D32
static uint8_t FanSwitch3 = 14;  //D15
static uint8_t FanSwitch4 = 27;  //D4
static uint8_t FanSwitch5 = 26;  //D4

static uint8_t gpio_reset  = 0 ;   // Press BOOT to reset WiFi Details
static uint8_t wifiLed     = 2 ;   //D2
static uint8_t IR_RECV_PIN = 17;   // D35 (IR receiver pin)
...
bool fanSpeed_5 = LOW; //Define integer to remember the toggle state for relay 9
...
void setup()
{
  ...
  pinMode(FanSwitch5, INPUT_PULLUP);
  ...
  speed.addBounds(value(0), value(5), value(1));
...
{  
  ...
  manual_control(); //Control Switches Manualy
...
void fanRegularor(){
  ...
  if (digitalRead(FanSwitch2) == LOW && fanSpeed_2 == LOW)
  {
    currSpeed = 2;
    if(toggleState_5 == 1){
      fanSpeedControl(currSpeed); 
  ...
  if (digitalRead(FanSwitch3) == LOW && fanSpeed_3 == LOW)
  {
    currSpeed = 3;
    if(toggleState_5 == 1){
      fanSpeedControl(currSpeed); 
  ...
  if (digitalRead(FanSwitch5) == LOW  && fanSpeed_5 == LOW)
  {
    currSpeed = 5;
    if(toggleState_5 == 1){
      fanSpeedControl(currSpeed); 
